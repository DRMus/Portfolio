...
const DescriptionPersonLine: FC<Props> = ({ label, paragraph }) => {
  const componentClassNames = {
    ...
    label: classNames("!m-0 w-20 text-right", "md:max-lg:w-auto md:max-lg:text-base", "sm:max-md:w-auto sm:max-md:text-base"),
    paragraph: classNames("text-xl", "md:max-lg:text-2xl", "sm:max-md:text-2xl"),
  };
  return (
