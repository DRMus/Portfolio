    ...
    >
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="img relative">
          ...
          <div className="absolute top-0 bottom-0 right-0 left-0 transition-opacity duration-200 backdrop-blur-[1px] rounded-lg backdrop-grayscale group-hover:opacity-0"></div>
        </div>
      </div>
    </div>
  );
